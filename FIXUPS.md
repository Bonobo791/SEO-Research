...
| S5-04 | `influential_rows_rate` warn guardrail — Slice 8 wires Cook's D rate into per-depth guardrails and `### Influence robustness` report sections | 5 Slice 8 | nice-to-have | done |
