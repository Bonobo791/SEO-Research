...
CURATED_SCHEMAS = {
    ...
    "entities": pa.schema(
        [
            ...
            ("wiki_link", pa.string()),
            ("freebase_types", pa.list_(pa.string())),
            ("enriched_data_keys", pa.list_(pa.string())),
            ("schema_version", pa.string()),
        ]
    ),
    "textrazor_page_metrics_curated": pa.schema(
        [
            ...
            ("textrazor_top_topic_label", pa.string()),
            ("textrazor_top_topic_score", pa.float64()),
            ("textrazor_category_score", pa.float64()),
            ("textrazor_classifier_score", pa.float64()),
            ("textrazor_top_category_label", pa.string()),
            ("textrazor_top_category_classifier_id", pa.string()),
            ...
            ("textrazor_sense_score", pa.float64()),
            ("textrazor_spelling_suggestion_count", pa.int64()),
            ("textrazor_relation_count", pa.int64()),
            ("textrazor_property_count", pa.int64()),
            ("textrazor_noun_phrase_count", pa.int64()),
            ("textrazor_top_noun_phrase_texts", pa.list_(pa.string())),
            ("textrazor_relation_predicate_labels", pa.list_(pa.string())),
            ("textrazor_relation_param_labels", pa.list_(pa.string())),
            ("textrazor_property_names", pa.list_(pa.string())),
            ("textrazor_dependency_depth_mean", pa.float64()),
            ("textrazor_dependency_relation_type_count", pa.int64()),
            ("textrazor_part_of_speech_type_count", pa.int64()),
            ("textrazor_entity_mention_count", pa.int64()),
            ("textrazor_unique_entity_count", pa.int64()),
            ("textrazor_unique_entity_density_per_1k_words", pa.float64()),
            ("textrazor_entity_mention_density_per_1k_words", pa.float64()),
            ...
            ("textrazor_dependency_trees_present", pa.bool_()),
    ...
    "onpage_signals": pa.schema(
        [
            ...
            ("connection_time_ms", pa.int64()),
            ("time_to_secure_connection_ms", pa.int64()),
            ("request_sent_time_ms", pa.int64()),
            ("download_time_ms", pa.int64()),
            ("duration_time_ms", pa.int64()),
            ("fetch_end_ms", pa.int64()),
            ("dom_complete_ms", pa.int64()),
            ("time_to_interactive_ms", pa.int64()),
            ("first_input_delay_ms", pa.float64()),
...
CURATED_VALIDATION_RULES = {
    ...
    "entities": {
        "expected_schema": {
            ...
            "wikidata_id": pl.Utf8,
            "wiki_link": pl.Utf8,
            "freebase_types": pl.List(pl.Utf8),
            "enriched_data_keys": pl.List(pl.Utf8),
            "schema_version": pl.Utf8,
        },
    ...
    "onpage_signals": {
        "expected_schema": {
            ...
            "connection_time_ms": pl.Int64,
            "time_to_secure_connection_ms": pl.Int64,
            "request_sent_time_ms": pl.Int64,
            "download_time_ms": pl.Int64,
            "duration_time_ms": pl.Int64,
            "fetch_end_ms": pl.Int64,
            "dom_complete_ms": pl.Int64,
            "time_to_interactive_ms": pl.Int64,
            "first_input_delay_ms": pl.Float64,
            ...
            rows.append(
                {
                    ...
                    "entity_english_id": entity["entity_english_id"],
                    ...
                    "freebase_types": list(entity["freebase_types"]),
                    "enriched_data_keys": list(entity["enriched_data_keys"]),
                    "schema_version": CURATED_SCHEMA_VERSION,
                }
            )
    if not rows:
...
def _onpage_signals_row(
    *,
    ...
    row: dict[str, object] = {
        ...
        "connection_time_ms": _optional_mapping_int(page_timing, "connection_time"),
        "time_to_secure_connection_ms": _optional_mapping_int(
            page_timing, "time_to_secure_connection"
        ),
        "request_sent_time_ms": _optional_mapping_int(page_timing, "request_sent_time"),
        "download_time_ms": _optional_mapping_int(page_timing, "download_time"),
        "duration_time_ms": _optional_mapping_int(page_timing, "duration_time"),
        "fetch_end_ms": _optional_mapping_int(page_timing, "fetch_end"),
        "dom_complete_ms": _optional_mapping_int(page_timing, "dom_complete"),
        "time_to_interactive_ms": _optional_mapping_int(page_timing, "time_to_interactive"),
        "first_input_delay_ms": _optional_mapping_number(page_timing, "first_input_delay"),
