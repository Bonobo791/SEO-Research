...
4. Use task-based model selection: documentation `gpt-5.4 low`, coding
   `gpt-5.5 medium`, review/QA `gpt-5.4 high`, security `gpt-5.5 high`,
   installs/configuration `gpt-5.5 xhigh`.
